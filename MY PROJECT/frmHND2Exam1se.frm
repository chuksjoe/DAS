...
Begin VB.Form frmHND2Exam 
   BackColor       =   &H00C0C0FF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "HND II Student Examination Details"
   ClientHeight    =   9225
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   7680
   Icon            =   "frmHND2Exam1se.frx":0000
   LinkTopic       =   "Form2"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame fraHND2MExam 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frmHND2Exam1se.frx":234CD
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "Line1"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).Control(1)=   "lblRegNo"
         Tab(0).Control(1).Enabled=   0   'False
         Tab(0).Control(2)=   "lblName"
         Tab(0).Control(2).Enabled=   0   'False
         Tab(0).Control(3)=   "lblCom413"
         Tab(0).Control(3).Enabled=   0   'False
         Tab(0).Control(4)=   "lblCom414"
         Tab(0).Control(4).Enabled=   0   'False
         Tab(0).Control(5)=   "lblCom415"
         Tab(0).Control(5).Enabled=   0   'False
         Tab(0).Control(6)=   "lblCom416"
         Tab(0).Control(6).Enabled=   0   'False
         Tab(0).Control(7)=   "lblSta411"
         Tab(0).Control(7).Enabled=   0   'False
         Tab(0).Control(8)=   "lblCom412"
         ...
         Tab(0).Control(23)=   "adoHND2Exam1s"
         Tab(0).Control(23).Enabled=   0   'False
         Tab(0).Control(24)=   "cmdBack"
         Tab(0).Control(24).Enabled=   0   'False
         Tab(0).Control(25)=   "cmdSearch"
         Tab(0).Control(25).Enabled=   0   'False
         Tab(0).Control(26)=   "cmdDelete"
         Tab(0).Control(26).Enabled=   0   'False
         Tab(0).Control(27)=   "cmdAdd"
         Tab(0).Control(27).Enabled=   0   'False
         Tab(0).ControlCount=   28
         TabCaption(1)   =   "Second Semester"
         TabPicture(1)   =   "frmHND2Exam1se.frx":234E9
         ...
         Tab(1).Control(19)=   "Label32"
         Tab(1).Control(19).Enabled=   0   'False
         Tab(1).Control(20)=   "lblName2"
         Tab(1).Control(20).Enabled=   0   'False
         Tab(1).Control(21)=   "Label34"
         Tab(1).Control(21).Enabled=   0   'False
         Tab(1).Control(22)=   "Line2"
         Tab(1).Control(22).Enabled=   0   'False
         Tab(1).Control(23)=   "adoHND2Exam2s"
         Tab(1).Control(23).Enabled=   0   'False
         Tab(1).Control(24)=   "cmdAdd2"
         Tab(1).Control(24).Enabled=   0   'False
         Tab(1).Control(25)=   "cmdDelete2"
         Tab(1).Control(25).Enabled=   0   'False
         Tab(1).Control(26)=   "cmdSearch2"
         Tab(1).Control(26).Enabled=   0   'False
         Tab(1).Control(27)=   "cmdBack2"
         ...
         Begin VB.CommandButton cmdBack 
            ...
            Width           =   1215
         End
         Begin MSAdodcLib.Adodc adoHND2Exam1s 
            Height          =   615
            Left            =   960
            Top             =   5880
            Width           =   5895
            ...
            _Version        =   393216
         End
         Begin MSAdodcLib.Adodc adoHND2Exam2s 
            Height          =   615
            Left            =   -74040
            Top             =   5880
            Width           =   5895
         ...
         Begin VB.Label Label26 
            Alignment       =   2  'Center
            BackStyle       =   0  'Transparent
            Caption         =   "HND II EXAMINATION DETAILS (SECOND SEMESTER)"
            BeginProperty Font 
               Name            =   "Agency FB"
               Size            =   21.75
               Charset         =   0
         ...
         Begin VB.Label Label1 
            Alignment       =   2  'Center
            BackStyle       =   0  'Transparent
            Caption         =   "HND II EXAMINATION DETAILS (FIRST SEMESTER)"
            BeginProperty Font 
               Name            =   "Agency FB"
               Size            =   21.75
               Charset         =   0
      ...
      Begin VB.Image Image1 
         Height          =   1815
         Left            =   0
         Picture         =   "frmHND2Exam1se.frx":23505
         Stretch         =   -1  'True
         Top             =   0
         Width           =   7695
      End
   End
   Begin VB.Frame fraHND2MEEdit 
      BackColor       =   &H0080FFFF&
      Height          =   9255
      Left            =   0
      TabIndex        =   76
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabHeight       =   520
         TabCaption(0)   =   "First Semester"
         TabPicture(0)   =   "frmHND2Exam1se.frx":472D3
         Tab(0).ControlEnabled=   -1  'True
         ...
         Tab(0).Control(10).Enabled=   0   'False
         Tab(0).Control(11)=   "Label45"
         Tab(0).Control(11).Enabled=   0   'False
         Tab(0).Control(12)=   "Label46"
         Tab(0).Control(12).Enabled=   0   'False
         Tab(0).Control(13)=   "Label47"
         Tab(0).Control(13).Enabled=   0   'False
         Tab(0).Control(14)=   "txtName"
         Tab(0).Control(14).Enabled=   0   'False
         Tab(0).Control(15)=   "cmdbk2Exam"
         Tab(0).Control(15).Enabled=   0   'False
         Tab(0).Control(16)=   "Combo1"
         Tab(0).Control(16).Enabled=   0   'False
         Tab(0).Control(17)=   "Combo6"
         Tab(0).Control(17).Enabled=   0   'False
         Tab(0).Control(18)=   "Combo5"
         Tab(0).Control(18).Enabled=   0   'False
         Tab(0).Control(19)=   "Combo4"
         Tab(0).Control(19).Enabled=   0   'False
         Tab(0).Control(20)=   "Combo3"
         Tab(0).Control(20).Enabled=   0   'False
         Tab(0).Control(21)=   "Combo2"
         Tab(0).Control(21).Enabled=   0   'False
         Tab(0).Control(22)=   "cmdAddR"
         Tab(0).Control(22).Enabled=   0   'False
         Tab(0).Control(23)=   "cmdCompute"
         Tab(0).Control(23).Enabled=   0   'False
         Tab(0).Control(24)=   "txtRegNo"
         Tab(0).Control(24).Enabled=   0   'False
         Tab(0).ControlCount=   25
         TabCaption(1)   =   "Second Semester"
         TabPicture(1)   =   "frmHND2Exam1se.frx":472EF
         Tab(1).ControlEnabled=   0   'False
         ...
         Tab(1).Control(13).Enabled=   0   'False
         Tab(1).Control(14)=   "txtName2"
         Tab(1).Control(14).Enabled=   0   'False
         Tab(1).Control(15)=   "cmdBk2Exam2"
         Tab(1).Control(15).Enabled=   0   'False
         Tab(1).Control(16)=   "Combo12"
         Tab(1).Control(16).Enabled=   0   'False
         Tab(1).Control(17)=   "Combo11"
         Tab(1).Control(17).Enabled=   0   'False
         ...
         Tab(1).Control(20).Enabled=   0   'False
         Tab(1).Control(21)=   "Combo7"
         Tab(1).Control(21).Enabled=   0   'False
         Tab(1).Control(22)=   "cmdAddR2"
         Tab(1).Control(22).Enabled=   0   'False
         Tab(1).Control(23)=   "cmdCompute2"
         Tab(1).Control(23).Enabled=   0   'False
         Tab(1).Control(24)=   "txtRegNo2"
         Tab(1).Control(24).Enabled=   0   'False
         ...
         Begin VB.ComboBox Combo7 
            ...
            DataSource      =   "adoHND2Exam2s"
            Height          =   315
            ItemData        =   "frmHND2Exam1se.frx":4730B
            Left            =   -72720
            List            =   "frmHND2Exam1se.frx":4732A
            TabIndex        =   13
            Text            =   "..."
            Top             =   3600
            Width           =   1215
         ...
         Begin VB.ComboBox Combo8 
            ...
            DataSource      =   "adoHND2Exam2s"
            Height          =   315
            ItemData        =   "frmHND2Exam1se.frx":4734C
            Left            =   -72720
            List            =   "frmHND2Exam1se.frx":4736B
            TabIndex        =   14
            Text            =   "..."
            Top             =   3960
            Width           =   1215
         ...
         Begin VB.ComboBox Combo9 
            ...
            DataSource      =   "adoHND2Exam2s"
            Height          =   315
            ItemData        =   "frmHND2Exam1se.frx":4738D
            Left            =   -72720
            List            =   "frmHND2Exam1se.frx":473AC
            TabIndex        =   15
            Text            =   "..."
            Top             =   4320
            Width           =   1215
         ...
         Begin VB.ComboBox Combo10 
            ...
            DataSource      =   "adoHND2Exam2s"
            Height          =   315
            ItemData        =   "frmHND2Exam1se.frx":473CE
            Left            =   -72720
            List            =   "frmHND2Exam1se.frx":473ED
            TabIndex        =   16
            Text            =   "..."
            Top             =   4680
            Width           =   1215
         ...
         Begin VB.ComboBox Combo11 
            ...
            DataSource      =   "adoHND2Exam2s"
            Height          =   315
            ItemData        =   "frmHND2Exam1se.frx":4740F
            Left            =   -72720
            List            =   "frmHND2Exam1se.frx":4742E
            TabIndex        =   17
            Text            =   "..."
            Top             =   5040
            Width           =   1215
         ...
         Begin VB.ComboBox Combo12 
            ...
            DataSource      =   "adoHND2Exam2s"
            Height          =   315
            ItemData        =   "frmHND2Exam1se.frx":47450
            Left            =   -72720
            List            =   "frmHND2Exam1se.frx":4746F
            TabIndex        =   18
            Text            =   "..."
            Top             =   5400
            Width           =   1215
         ...
         Begin VB.ComboBox Combo2 
            ...
            DataSource      =   "adoHND2exam1s"
            Height          =   315
            ItemData        =   "frmHND2Exam1se.frx":47491
            Left            =   2280
            List            =   "frmHND2Exam1se.frx":474B0
            TabIndex        =   3
            Text            =   "..."
            Top             =   3960
            Width           =   1215
         ...
         Begin VB.ComboBox Combo3 
            ...
            DataSource      =   "adoHND2exam1s"
            Height          =   315
            ItemData        =   "frmHND2Exam1se.frx":474D2
            Left            =   2280
            List            =   "frmHND2Exam1se.frx":474F1
            TabIndex        =   4
            Text            =   "..."
            Top             =   4320
            Width           =   1215
         ...
         Begin VB.ComboBox Combo4 
            ...
            DataSource      =   "adoHND2exam1s"
            Height          =   315
            ItemData        =   "frmHND2Exam1se.frx":47513
            Left            =   2280
            List            =   "frmHND2Exam1se.frx":47532
            TabIndex        =   5
            Text            =   "..."
            Top             =   4680
            Width           =   1215
         ...
         Begin VB.ComboBox Combo5 
            ...
            DataSource      =   "adoHND2exam1s"
            Height          =   315
            ItemData        =   "frmHND2Exam1se.frx":47554
            Left            =   2280
            List            =   "frmHND2Exam1se.frx":47573
            TabIndex        =   6
            Text            =   "..."
            Top             =   5040
            Width           =   1215
         ...
         Begin VB.ComboBox Combo6 
            ...
            DataSource      =   "adoHND2exam1s"
            Height          =   315
            ItemData        =   "frmHND2Exam1se.frx":47595
            Left            =   2280
            List            =   "frmHND2Exam1se.frx":475B4
            TabIndex        =   7
            Text            =   "..."
            Top             =   5400
            Width           =   1215
         ...
         Begin VB.ComboBox Combo1 
            ...
            DataSource      =   "adoHND2exam1s"
            Height          =   315
            ItemData        =   "frmHND2Exam1se.frx":475D6
            Left            =   2280
            List            =   "frmHND2Exam1se.frx":475F5
            TabIndex        =   2
            Text            =   "..."
            Top             =   3600
            Width           =   1215
      ...
      Begin VB.Image Image2 
         Height          =   1815
         Left            =   0
         Picture         =   "frmHND2Exam1se.frx":47617
         Stretch         =   -1  'True
         Top             =   0
         Width           =   7695
      End
...
adoHND2Exam1s.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:" & App.Path & "\ProjectStudents.mdb;Persist Security Info=False"
End Function
Private Function GetConnect2()
adoHND2Exam2s.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:" & App.Path & "\ProjectStudents.mdb;Persist Security Info=False"
End Function


Private Sub cmdAdd_Click()
fraHND2MExam.Visible = False
fraHND2MEEdit.Visible = True
SSTab2.Tab = 0
End Sub
...
fraHND2MEEdit.Visible = False
fraHND2MExam.Visible = True
SSTab1.Tab = 0
End Sub
...
BookMark1 = adoHND2Exam1s.Recordset.Bookmark
adoHND2Exam1s.Recordset.MoveFirst
adoHND2Exam1s.Recordset.Find "regno = '" & con & "'", 0, adSearchForward
If adoHND2Exam1s.Recordset.EOF = True Then
adoHND2Exam1s.Recordset.Bookmark = BookMark1
...
On Error GoTo joe
GetConnect1
adoHND2Exam1s.Recordset.AddNew
Exit Sub
joe:
MsgBox Err.Description
End Sub
...
On Error GoTo joe
GetConnect2
adoHND2Exam2s.Recordset.AddNew
Exit Sub
joe:
MsgBox Err.Description
End Sub
...
Dim con As String
con = InputBox("Enter Student Reg. Number", "Search By Reg. No.")
BookMark1 = adoHND2Exam2s.Recordset.Bookmark
adoHND2Exam2s.Recordset.MoveFirst
adoHND2Exam2s.Recordset.Find "regno = '" & con & "'", 0, adSearchForward
If adoHND2Exam2s.Recordset.EOF = True Then
adoHND2Exam2s.Recordset.Bookmark = BookMark1
MsgBox ("No Record Found")
End If
Exit Sub
joe:
