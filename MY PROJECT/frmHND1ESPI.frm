...
Begin VB.Form frmHND1ESPI 
   BackColor       =   &H00C0FFFF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "HND I(Evening) Student Personal Information."
   ClientHeight    =   10950
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   9945
   Icon            =   "frmHND1ESPI.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame fraHND1ESPI 
      ...
      Begin VB.CommandButton cmdBack 
         ...
         Width           =   1215
      End
      Begin MSAdodcLib.Adodc adoHND1E 
         Height          =   375
         Left            =   2040
         Top             =   9840
         Width           =   4935
      ...
      Begin VB.Label Label21 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "HND I(EVENING) STUDENTS PERSONAL INFORMATION"
         BeginProperty Font 
            Name            =   "Agency FB"
            Size            =   18
            Charset         =   0
      ...
      End
   End
   Begin VB.Frame fraHND1ESPreview 
      BackColor       =   &H00C0FFC0&
      Height          =   10575
      Left            =   0
      TabIndex        =   38
      ...
      End
   End
   Begin VB.Frame fraHND1ESEditor 
      BackColor       =   &H0080FF80&
      Height          =   10935
      Left            =   0
      TabIndex        =   77
      ...
      Begin VB.Frame fraBiaData 
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.ComboBox cboDay 
               Height          =   315
               ItemData        =   "frmHND1ESPI.frx":5B8DB
               Left            =   600
               List            =   "frmHND1ESPI.frx":5B93C
               TabIndex        =   94
               Top             =   240
               Width           =   735
            End
            Begin VB.ComboBox cboMonth 
               Height          =   315
               ItemData        =   "frmHND1ESPI.frx":5B9B3
               Left            =   2160
               List            =   "frmHND1ESPI.frx":5B9DE
               TabIndex        =   93
               Top             =   240
               Width           =   975
            End
            Begin VB.ComboBox cboYear 
               Height          =   315
               ItemData        =   "frmHND1ESPI.frx":5BA27
               Left            =   3840
               List            =   "frmHND1ESPI.frx":5BAC4
               TabIndex        =   92
               Top             =   240
               Width           =   855
            End
         ...
         Begin VB.Frame Frame5 
            ...
            Begin VB.ComboBox cboCountry 
               Height          =   315
               ItemData        =   "frmHND1ESPI.frx":5BBFA
               Left            =   840
               List            =   "frmHND1ESPI.frx":5BC04
               TabIndex        =   85
               Top             =   360
               Width           =   2295
            End
            Begin VB.ComboBox cboState 
               Height          =   315
               ItemData        =   "frmHND1ESPI.frx":5BC19
               Left            =   5880
               List            =   "frmHND1ESPI.frx":5BC8F
               TabIndex        =   84
               Top             =   360
               Width           =   2055
            End
            Begin VB.ComboBox cboReligion 
               Height          =   315
               ItemData        =   "frmHND1ESPI.frx":5BDB3
               Left            =   5400
               List            =   "frmHND1ESPI.frx":5BDC0
               TabIndex        =   83
               Top             =   720
               Width           =   2535
            End
      ...
      Begin VB.Label Label56 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "HND I(EVENING) STUDENT PERSONAL INFO EDITOR"
         BeginProperty Font 
            Name            =   "Agency FB"
            Size            =   21.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmHND1ESPI"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Function GetConnect()
adoHND1E.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:" & App.Path & "\ProjectStudents.mdb;Persist Security Info=False"
End Function

Private Sub cmdAdd_Click()
fraHND1ESPI.Visible = False
fraHND1ESPreview.Visible = True
Me.Width = 9570
Me.Height = 10950
End Sub
...
fraHND1ESPI.Visible = True
fraHND1ESPreview.Visible = False
Me.Width = 8955
Me.Height = 11325
End Sub
