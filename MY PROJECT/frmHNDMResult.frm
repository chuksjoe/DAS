...
Begin VB.Form frmHNDMResult 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabsPerRow      =   4
      TabHeight       =   520
      TabCaption(0)   =   "HND I(Morning) 1st Semester"
      TabPicture(0)   =   "frmHNDMResult.frx":234CD
      ...
      TabCaption(1)   =   "HND I(Morning) 2nd Semester"
      TabPicture(1)   =   "frmHNDMResult.frx":234E9
      ...
      TabCaption(2)   =   "HND II(Morning) 1st Semester"
      TabPicture(2)   =   "frmHNDMResult.frx":23505
      ...
      TabPicture(3)   =   "frmHNDMResult.frx":23521
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmHNDMResult.frx":2353D
         Height          =   8895
         Left            =   120
         TabIndex        =   5
         Top             =   1080
      ...
      Begin MSDataGridLib.DataGrid DataGrid2 
         Bindings        =   "frmHNDMResult.frx":23552
         Height          =   8895
         Left            =   -74880
         TabIndex        =   6
         Top             =   1080
      ...
      Begin MSDataGridLib.DataGrid DataGrid3 
         Bindings        =   "frmHNDMResult.frx":23567
         Height          =   8895
         Left            =   -74880
         TabIndex        =   7
         Top             =   1080
      ...
      Begin MSDataGridLib.DataGrid DataGrid4 
         Bindings        =   "frmHNDMResult.frx":2357C
         Height          =   8895
         Left            =   -74880
         TabIndex        =   8
         Top             =   1080
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   "HND I(MORNING) FIRST SEMESTER RESULT TABLE"
         BeginProperty Font 
      ...
      Begin VB.Label Label2 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "HND I(MORNING) SECOND SEMESTER RESULT TABLE"
         BeginProperty Font 
            Name            =   "American Classic"
            Size            =   20.25
            Charset         =   0
      ...
      Begin VB.Label Label3 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "HND II(MORNING) FIRST SEMESTER RESULT TABLE"
         BeginProperty Font 
            Name            =   "American Classic"
            Size            =   20.25
            Charset         =   0
      ...
      Begin VB.Label Label4 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "HND II(MORNING) SECOND SEMESTER RESULT TABLE"
         BeginProperty Font 
            Name            =   "American Classic"
            Size            =   20.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmHNDMResult"
