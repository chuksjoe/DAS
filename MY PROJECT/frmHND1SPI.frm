...
Begin VB.Form frmHND1SPI 
   BackColor       =   &H00C0FFFF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "HND I, Student Personal Information"
   ClientHeight    =   11040
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   9945
   Icon            =   "frmHND1SPI.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame fraHND1MSEditor 
      BackColor       =   &H0000FF00&
      Height          =   11055
      Left            =   0
      TabIndex        =   38
      ...
      Begin VB.Frame fraBiaData 
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.ComboBox cboReligion 
               Height          =   315
               ItemData        =   "frmHND1SPI.frx":234CD
               Left            =   5400
               List            =   "frmHND1SPI.frx":234DA
               TabIndex        =   77
               Top             =   720
               Width           =   2535
            End
            Begin VB.ComboBox cboState 
               Height          =   315
               ItemData        =   "frmHND1SPI.frx":234F9
               Left            =   5880
               List            =   "frmHND1SPI.frx":2356F
               TabIndex        =   76
               Top             =   360
               Width           =   2055
            End
            Begin VB.ComboBox cboCountry 
               Height          =   315
               ItemData        =   "frmHND1SPI.frx":23693
               Left            =   840
               List            =   "frmHND1SPI.frx":2369D
               TabIndex        =   75
               Top             =   360
               Width           =   2295
            End
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.ComboBox cboYear 
               Height          =   315
               ItemData        =   "frmHND1SPI.frx":236B2
               Left            =   3840
               List            =   "frmHND1SPI.frx":2374F
               TabIndex        =   70
               Top             =   240
               Width           =   855
            End
            Begin VB.ComboBox cboMonth 
               Height          =   315
               ItemData        =   "frmHND1SPI.frx":23885
               Left            =   2160
               List            =   "frmHND1SPI.frx":238AD
               TabIndex        =   69
               Top             =   240
               Width           =   975
            End
            Begin VB.ComboBox cboDay 
               Height          =   315
               ItemData        =   "frmHND1SPI.frx":238F2
               Left            =   600
               List            =   "frmHND1SPI.frx":23953
               TabIndex        =   68
               Top             =   240
               Width           =   735
            End
      ...
      Begin VB.Label Label38 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "HND I STUDENT PERSONAL INFO EDITOR"
         BeginProperty Font 
            Name            =   "Agency FB"
            Size            =   21.75
            Charset         =   0
   ...
   Begin VB.Frame fraHND1MSPI 
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Width           =   1815
      End
      Begin MSAdodcLib.Adodc adoHND1 
         Height          =   375
         Left            =   2040
         Top             =   9840
         Width           =   4935
      ...
      Begin VB.Label Label21 
         BackStyle       =   0  'Transparent
         Caption         =   "HND I STUDENTS PERSONAL INFORMATION"
         BeginProperty Font 
            Name            =   "Agency FB"
            Size            =   18
            Charset         =   0
      ...
      Begin VB.Image Image1 
         Height          =   1815
         Left            =   0
         Picture         =   "frmHND1SPI.frx":47798
         Stretch         =   -1  'True
         Top             =   0
         Width           =   8895
      End
   End
   Begin VB.Frame fraHND1MSPreview 
      BackColor       =   &H0080FF80&
      Height          =   10575
      Left            =   0
      TabIndex        =   89
   ...
   End
End
Attribute VB_Name = "frmHND1SPI"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Function GetConnect()
adoHND1.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:" & App.Path & "\ProjectStudents.mdb;Persist Security Info=False"
End Function

Private Sub cmdAdd_Click()
fraHND1MSPI.Visible = False
fraHND1MSPreview.Visible = True
Me.Width = 9570
Me.Height = 10950
End Sub
...
fraHND1MSPI.Visible = True
fraHND1MSPreview.Visible = False
Me.Width = 8955
Me.Height = 11325
End Sub

Private Sub cmdEdit_Click()
fraHND1MSEditor.Visible = True
fraHND1MSPreview.Visible = False
Me.Width = 10080
Me.Height = 11520
txtSurname = ""
