...
Begin VB.Form frmND2ESPI 
   BackColor       =   &H00FFFFC0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "ND II(Evening) Student Personal Information"
   ClientHeight    =   11010
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   9945
   Icon            =   "frmND2ESPI.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame fraND2ESPreview 
      BackColor       =   &H00C0FFC0&
      Height          =   10455
      Left            =   0
      TabIndex        =   38
      ...
      Begin VB.Image Image2 
         Height          =   735
         Left            =   0
         Picture         =   "frmND2ESPI.frx":234CD
         Stretch         =   -1  'True
         Top             =   0
         Width           =   9495
      End
   End
   Begin VB.Frame fraND2ESPI 
      BackColor       =   &H0000C000&
      Height          =   10935
      Left            =   0
      TabIndex        =   0
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Width           =   1815
      End
      Begin MSAdodcLib.Adodc adoND2E 
         Height          =   375
         Left            =   2040
         Top             =   9840
         Width           =   4935
      ...
      Begin VB.Label Label21 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "ND II(EVENING) STUDENTS PERSONAL INFORMATION"
         BeginProperty Font 
            Name            =   "Amelia"
            Size            =   15.75
            Charset         =   0
      ...
      Begin VB.Image Image1 
         Height          =   1815
         Left            =   0
         Picture         =   "frmND2ESPI.frx":37B0D
         Stretch         =   -1  'True
         Top             =   0
         Width           =   8895
      End
   End
   Begin VB.Frame fraND2ESEditor 
      BackColor       =   &H0080FF80&
      Height          =   11175
      Left            =   0
      TabIndex        =   77
      ...
      Begin VB.Frame fraBiaData 
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.ComboBox cboReligion 
               Height          =   315
               ItemData        =   "frmND2ESPI.frx":5B8DB
               Left            =   5400
               List            =   "frmND2ESPI.frx":5B8E8
               TabIndex        =   117
               Top             =   720
               Width           =   2535
            End
            Begin VB.ComboBox cboState 
               Height          =   315
               ItemData        =   "frmND2ESPI.frx":5B907
               Left            =   5880
               List            =   "frmND2ESPI.frx":5B97D
               TabIndex        =   116
               Top             =   360
               Width           =   2055
            End
            Begin VB.ComboBox cboCountry 
               Height          =   315
               ItemData        =   "frmND2ESPI.frx":5BAA1
               Left            =   840
               List            =   "frmND2ESPI.frx":5BAAB
               TabIndex        =   115
               Top             =   360
               Width           =   2295
            End
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.ComboBox cboYear 
               Height          =   315
               ItemData        =   "frmND2ESPI.frx":5BAC0
               Left            =   3840
               List            =   "frmND2ESPI.frx":5BB5D
               TabIndex        =   109
               Top             =   240
               Width           =   855
            End
            Begin VB.ComboBox cboMonth 
               Height          =   315
               ItemData        =   "frmND2ESPI.frx":5BC93
               Left            =   2160
               List            =   "frmND2ESPI.frx":5BCBE
               TabIndex        =   108
               Top             =   240
               Width           =   975
            End
            Begin VB.ComboBox cboDay 
               Height          =   315
               ItemData        =   "frmND2ESPI.frx":5BD07
               Left            =   600
               List            =   "frmND2ESPI.frx":5BD68
               TabIndex        =   107
               Top             =   240
               Width           =   735
            End
      ...
      Begin VB.Label Label57 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "ND II(EVENING) STUDENT PERSONAL INFO EDITOR"
         BeginProperty Font 
            Name            =   "Amelia"
            Size            =   20.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmND2ESPI"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Function GetConnect1()
adoND2E.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:" & App.Path & "\ProjectStudents.mdb;Persist Security Info=False"
End Function

Private Sub cmdAdd_Click()
fraND2ESPI.Visible = False
fraND2ESPreview.Visible = True
Me.Width = 9570
Me.Height = 10950
End Sub
...
fraND2ESPI.Visible = True
fraND2ESPreview.Visible = False
Me.Width = 8955
Me.Height = 11325
End Sub
