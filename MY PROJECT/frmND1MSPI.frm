...
Begin VB.Form frmND1MSPI 
   BackColor       =   &H00C0C0FF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "ND I(Morning) Student Personal Information"
   ClientHeight    =   11100
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   9945
   Icon            =   "frmND1MSPI.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame fraND1MSPI 
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Width           =   1815
      End
      Begin MSAdodcLib.Adodc adoND1M 
         Height          =   375
         Left            =   2040
         Top             =   9840
         Width           =   4935
      ...
      Begin VB.Label Label21 
         ...
         Caption         =   "ND I(MORNING) STUDENTS PERSONAL INFORMATION"
         BeginProperty Font 
            Name            =   "Amelia"
            Size            =   15.75
            Charset         =   0
      ...
      Begin VB.Image Image1 
         Height          =   1815
         Left            =   0
         Picture         =   "frmND1MSPI.frx":234CD
         Stretch         =   -1  'True
         Top             =   0
         Width           =   8895
      End
   End
   Begin VB.Frame fraND1MSPreview 
      BackColor       =   &H00C0FFC0&
      Caption         =   "Frame1"
      Height          =   10575
      Left            =   0
      ...
      Begin VB.Image Image3 
         Height          =   735
         Left            =   0
         Picture         =   "frmND1MSPI.frx":4729B
         Stretch         =   -1  'True
         Top             =   0
         Width           =   9495
      End
   End
   Begin VB.Frame fraND1MSEditor 
      BackColor       =   &H0080FF80&
      Height          =   11175
      Left            =   0
      TabIndex        =   38
      ...
      Begin VB.Frame fraBiaData 
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.ComboBox cboReligion 
               Height          =   315
               ItemData        =   "frmND1MSPI.frx":5B8DB
               Left            =   5400
               List            =   "frmND1MSPI.frx":5B8E8
               TabIndex        =   57
               Top             =   720
               Width           =   2535
            End
            Begin VB.ComboBox cboState 
               Height          =   315
               ItemData        =   "frmND1MSPI.frx":5B907
               Left            =   5880
               List            =   "frmND1MSPI.frx":5B97D
               TabIndex        =   56
               Top             =   360
               Width           =   2055
            End
            Begin VB.ComboBox cboCountry 
               Height          =   315
               ItemData        =   "frmND1MSPI.frx":5BAA1
               Left            =   840
               List            =   "frmND1MSPI.frx":5BAAB
               TabIndex        =   55
               Top             =   360
               Width           =   2295
            End
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.ComboBox cboYear 
               Height          =   315
               ItemData        =   "frmND1MSPI.frx":5BAC0
               Left            =   3840
               List            =   "frmND1MSPI.frx":5BB5D
               TabIndex        =   50
               Top             =   240
               Width           =   855
            End
            Begin VB.ComboBox cboMonth 
               Height          =   315
               ItemData        =   "frmND1MSPI.frx":5BC93
               Left            =   2160
               List            =   "frmND1MSPI.frx":5BCBE
               TabIndex        =   49
               Top             =   240
               Width           =   975
            End
            Begin VB.ComboBox cboDay 
               Height          =   315
               ItemData        =   "frmND1MSPI.frx":5BD07
               Left            =   600
               List            =   "frmND1MSPI.frx":5BD68
               TabIndex        =   48
               Top             =   240
               Width           =   735
            End
      ...
      Begin VB.Label Label37 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "ND I(MORNING) STUDENT PERSONAL INFO EDITOR"
         BeginProperty Font 
            Name            =   "Amelia"
            Size            =   20.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmND1MSPI"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Function GetConnect1()
adoND1M.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:" & App.Path & "\ProjectStudents.mdb;Persist Security Info=False"
End Function

Private Sub cmdAdd_Click()
fraND1MSPI.Visible = False
fraND1MSPreview.Visible = True
Me.Width = 9570
Me.Height = 10950
End Sub
...
fraND1MSPreview.Visible = False
fraND1MSEditor.Visible = True
Me.Width = 10080
Me.Height = 11520
txtSurname = ""
TxtFirstname = ""
...
Me.Width = 9570
Me.Height = 10950
lblRegNo.Caption = txtRegNo1.Text + "/" + txtRegNo2.Text + "/" + lbldept.Caption
lblStuName.Caption = txtSurname.Text + " " + TxtFirstname.Text + " " + txtMiddleI.Text
lbldobirth.Caption = cboDay.Text + "/" + cboMonth.Text + "/" + cboYear.Text
...
lblStaOfOrigin.Caption = cboState.Text
lblReligion.Caption = cboReligion.Text
lblLga.Caption = txtLGA.Text
lblContact.Caption = txtContact.Text
lblHome.Caption = txtHome.Text
lblPhone.Caption = txtPhone.Text
lblParentN.Caption = txtParentN.Text
lblParentC.Caption = TxtParentC.Text
lblParentP.Caption = txtParentP.Text
lblParentOc.Caption = txtParentOc.Text
End Sub
