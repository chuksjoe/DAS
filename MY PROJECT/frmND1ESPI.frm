...
Begin VB.Form frmND1ESPI 
   BackColor       =   &H00FFC0C0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "ND I(Evening) Student Personal Information"
   ClientHeight    =   10905
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   9945
   Icon            =   "frmND1ESPI.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame fraND1ESpreview 
      BackColor       =   &H00C0FFC0&
      Height          =   10575
      Left            =   0
      TabIndex        =   38
      ...
      Begin VB.Image Image2 
         Height          =   735
         Left            =   0
         Picture         =   "frmND1ESPI.frx":234CD
         Stretch         =   -1  'True
         Top             =   0
         Width           =   9495
      End
   End
   Begin VB.Frame fraND1ESPI 
      BackColor       =   &H0080FF80&
      Height          =   10935
      Left            =   0
      TabIndex        =   0
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Width           =   1815
      End
      Begin MSAdodcLib.Adodc adoND1E 
         Height          =   375
         Left            =   2040
         Top             =   9840
         Width           =   4935
      ...
      Begin VB.Label Label21 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "ND I(EVENING) STUDENTS PERSONAL INFORMATION"
         BeginProperty Font 
            Name            =   "Amelia"
            Size            =   15.75
            Charset         =   0
      ...
      Begin VB.Image Image1 
         Height          =   1815
         Left            =   0
         Picture         =   "frmND1ESPI.frx":37B0D
         Stretch         =   -1  'True
         Top             =   0
         Width           =   8895
      End
   End
   Begin VB.Frame fraND1ESeditor 
      BackColor       =   &H00C0FFC0&
      Height          =   11055
      Left            =   0
      TabIndex        =   77
      ...
      Begin VB.Frame fraBiaData 
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.ComboBox cboReligion 
               Height          =   315
               ItemData        =   "frmND1ESPI.frx":5B8DB
               Left            =   5400
               List            =   "frmND1ESPI.frx":5B8E8
               TabIndex        =   96
               Top             =   720
               Width           =   2535
            End
            Begin VB.ComboBox cboState 
               Height          =   315
               ItemData        =   "frmND1ESPI.frx":5B907
               Left            =   5880
               List            =   "frmND1ESPI.frx":5B97D
               TabIndex        =   95
               Top             =   360
               Width           =   2055
            End
            Begin VB.ComboBox cboCountry 
               Height          =   315
               ItemData        =   "frmND1ESPI.frx":5BAA1
               Left            =   840
               List            =   "frmND1ESPI.frx":5BAAB
               TabIndex        =   94
               Top             =   360
               Width           =   2295
            End
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.ComboBox cboYear 
               Height          =   315
               ItemData        =   "frmND1ESPI.frx":5BAC0
               Left            =   3840
               List            =   "frmND1ESPI.frx":5BB5D
               TabIndex        =   89
               Top             =   240
               Width           =   855
            End
            Begin VB.ComboBox cboMonth 
               Height          =   315
               ItemData        =   "frmND1ESPI.frx":5BC93
               Left            =   2160
               List            =   "frmND1ESPI.frx":5BCBE
               TabIndex        =   88
               Top             =   240
               Width           =   975
            End
            Begin VB.ComboBox cboDay 
               Height          =   315
               ItemData        =   "frmND1ESPI.frx":5BD07
               Left            =   600
               List            =   "frmND1ESPI.frx":5BD68
               TabIndex        =   87
               Top             =   240
               Width           =   735
            End
      ...
      Begin VB.Label Label56 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "ND I(EVENING) STUDENT PERSONAL INFO EDITOR"
         BeginProperty Font 
            Name            =   "Amelia"
            Size            =   20.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmND1ESPI"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Function GetConnect()
adoND1E.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:" & App.Path & "\ProjectStudents.mdb;Persist Security Info=False"
End Function

Private Sub cmdAdd_Click()
fraND1ESPI.Visible = False
fraND1ESpreview.Visible = True
Me.Width = 9570
Me.Height = 10950
End Sub
...
fraND1ESeditor.Visible = False
fraND1ESpreview.Visible = True
Me.Width = 9570
Me.Height = 10950
End Sub

Private Sub cmdBk2SPI_Click(Index As Integer)
fraND1ESPI.Visible = True
fraND1ESpreview.Visible = False
Me.Width = 8955
Me.Height = 11325
End Sub
