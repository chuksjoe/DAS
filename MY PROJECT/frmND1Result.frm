...
Begin VB.Form frmNDMResult 
   BackColor       =   &H00FFC0FF&
   Caption         =   "ND(Morning) Result Table."
   ClientHeight    =   10800
   ClientLeft      =   195
   ClientTop       =   525
   ClientWidth     =   20250
   Icon            =   "frmND1Result.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   10800
   ScaleWidth      =   20250
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabsPerRow      =   4
      TabHeight       =   520
      TabCaption(0)   =   "ND I(Morning) 1st Semester"
      TabPicture(0)   =   "frmND1Result.frx":234CD
      ...
      TabCaption(1)   =   "ND I(Morning) 2nd Semester"
      TabPicture(1)   =   "frmND1Result.frx":234E9
      ...
      TabCaption(2)   =   "ND II(Morning) 1st Semester"
      TabPicture(2)   =   "frmND1Result.frx":23505
      ...
      TabCaption(3)   =   "ND II(Morning) 2nd Semester"
      TabPicture(3)   =   "frmND1Result.frx":23521
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmND1Result.frx":2353D
         Height          =   8895
         Left            =   -74880
         TabIndex        =   2
         Top             =   1080
      ...
      Begin MSDataGridLib.DataGrid DataGrid2 
         Bindings        =   "frmND1Result.frx":23552
         Height          =   8895
         Left            =   -74880
         TabIndex        =   5
         Top             =   1080
      ...
      Begin MSDataGridLib.DataGrid DataGrid3 
         Bindings        =   "frmND1Result.frx":23567
         Height          =   8895
         Left            =   120
         TabIndex        =   8
         Top             =   1080
      ...
      Begin MSDataGridLib.DataGrid DataGrid4 
         Bindings        =   "frmND1Result.frx":2357C
         Height          =   8895
         Left            =   -74880
         TabIndex        =   11
         Top             =   1080
      ...
      Begin VB.Label Label4 
         ...
         Caption         =   "ND II(MORNING) SECOND SEMESTER RESULT TABLE"
         BeginProperty Font 
      ...
      Begin VB.Label Label3 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "ND II(MORNING) FIRST SEMESTER RESULT TABLE"
         BeginProperty Font 
            Name            =   "American Classic"
            Size            =   20.25
            Charset         =   0
      ...
      Begin VB.Label Label2 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "ND I(MORNING) SECOND SEMESTER RESULT TABLE"
         BeginProperty Font 
            Name            =   "American Classic"
            Size            =   20.25
            Charset         =   0
      ...
      Begin VB.Label Label1 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "ND I(MORNING) FIRST SEMESTER RESULT TABLE"
         BeginProperty Font 
            Name            =   "American Classic"
            Size            =   20.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmNDMResult"
