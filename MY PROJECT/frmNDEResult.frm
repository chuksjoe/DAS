...
Begin VB.Form frmNDEResult 
   BackColor       =   &H0080FFFF&
   Caption         =   "ND(Evening) Result Table."
   ClientHeight    =   10410
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   20250
   Icon            =   "frmNDEResult.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   10410
   ScaleWidth      =   20250
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabsPerRow      =   4
      TabHeight       =   520
      TabCaption(0)   =   "ND I(Evening) 1st Semester"
      TabPicture(0)   =   "frmNDEResult.frx":234CD
      ...
      TabCaption(1)   =   "ND I(Evening) 2nd Semester"
      TabPicture(1)   =   "frmNDEResult.frx":234E9
      ...
      TabCaption(2)   =   "ND II(Evening) 1st Semester"
      TabPicture(2)   =   "frmNDEResult.frx":23505
      ...
      TabCaption(3)   =   "ND II(Evening) 2nd Semester"
      TabPicture(3)   =   "frmNDEResult.frx":23521
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmNDEResult.frx":2353D
         Height          =   8895
         Left            =   -74880
         TabIndex        =   5
         Top             =   1080
      ...
      Begin MSDataGridLib.DataGrid DataGrid2 
         Bindings        =   "frmNDEResult.frx":23552
         Height          =   8895
         Left            =   -74880
         TabIndex        =   6
         Top             =   1080
      ...
      Begin MSDataGridLib.DataGrid DataGrid3 
         Bindings        =   "frmNDEResult.frx":23567
         Height          =   8895
         Left            =   -74880
         TabIndex        =   7
         Top             =   1080
      ...
      Begin MSDataGridLib.DataGrid DataGrid4 
         Bindings        =   "frmNDEResult.frx":2357C
         Height          =   8895
         Left            =   120
         TabIndex        =   8
         Top             =   1080
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   "ND I(EVENING) FIRST SEMESTER RESULT TABLE"
         BeginProperty Font 
      ...
      Begin VB.Label Label2 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "ND I(EVENING) SECOND SEMESTER RESULT TABLE"
         BeginProperty Font 
            Name            =   "American Classic"
            Size            =   20.25
            Charset         =   0
      ...
      Begin VB.Label Label3 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "ND II(EVENING) FIRST SEMESTER RESULT TABLE"
         BeginProperty Font 
            Name            =   "American Classic"
            Size            =   20.25
            Charset         =   0
      ...
      Begin VB.Label Label4 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "ND II(EVENING) SECOND SEMESTER RESULT TABLE"
         BeginProperty Font 
            Name            =   "American Classic"
            Size            =   20.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmNDEResult"
