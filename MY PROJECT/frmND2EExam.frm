...
Begin VB.Form frmND2EExam 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "ND II(Evening) Examination Details"
   ClientHeight    =   9690
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   7680
   Icon            =   "frmND2EExam.frx":0000
   LinkTopic       =   "Form2"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame fraND2EEEdit 
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabPicture(0)   =   "frmND2EExam.frx":234CD
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "txtRegNo"
         Tab(0).Control(1)=   "Combo2"
         Tab(0).Control(2)=   "Combo3"
         Tab(0).Control(3)=   "Combo4"
         Tab(0).Control(4)=   "Combo5"
         Tab(0).Control(5)=   "Combo6"
         Tab(0).Control(6)=   "Combo1"
         Tab(0).Control(7)=   "txtName"
         Tab(0).Control(8)=   "Combo7"
         Tab(0).Control(9)=   "cmdBk2Exam"
         Tab(0).Control(10)=   "cmdAddR"
         Tab(0).Control(11)=   "cmdCompute"
         Tab(0).Control(12)=   "Label52"
         Tab(0).Control(13)=   "Label51"
         Tab(0).Control(14)=   "Label50"
         Tab(0).Control(15)=   "Label49"
         Tab(0).Control(16)=   "Label48"
         Tab(0).Control(17)=   "Label47"
         Tab(0).Control(18)=   "lblGpa"
         Tab(0).Control(19)=   "lblTotal"
         Tab(0).Control(20)=   "Label46"
         Tab(0).Control(21)=   "Label44"
         Tab(0).Control(22)=   "Label42"
         Tab(0).Control(23)=   "Label41"
         Tab(0).Control(24)=   "Label40"
         Tab(0).Control(25)=   "Label39"
         Tab(0).Control(26)=   "Label38"
         Tab(0).ControlCount=   27
         TabCaption(1)   =   "Second Semester"
         TabPicture(1)   =   "frmND2EExam.frx":234E9
         ...
         Tab(1).Control(8)=   "lblTotal2"
         Tab(1).Control(8).Enabled=   0   'False
         Tab(1).Control(9)=   "lblGpa2"
         ...
         Tab(1).Control(17)=   "cmdAddR2"
         Tab(1).Control(17).Enabled=   0   'False
         Tab(1).Control(18)=   "cmdCompute2"
         Tab(1).Control(18).Enabled=   0   'False
         Tab(1).Control(19)=   "Combo17"
         Tab(1).Control(19).Enabled=   0   'False
         Tab(1).Control(20)=   "Text2"
         Tab(1).Control(20).Enabled=   0   'False
         Tab(1).Control(21)=   "Combo16"
         Tab(1).Control(21).Enabled=   0   'False
         Tab(1).Control(22)=   "Combo15"
         Tab(1).Control(22).Enabled=   0   'False
         Tab(1).Control(23)=   "Combo14"
         Tab(1).Control(23).Enabled=   0   'False
         Tab(1).Control(24)=   "Combo13"
         Tab(1).Control(24).Enabled=   0   'False
         Tab(1).Control(25)=   "Combo12"
         Tab(1).Control(25).Enabled=   0   'False
         Tab(1).Control(26)=   "Combo11"
         Tab(1).Control(26).Enabled=   0   'False
         Tab(1).Control(27)=   "Text1"
         Tab(1).Control(27).Enabled=   0   'False
         Tab(1).Control(28)=   "Combo10"
         Tab(1).Control(28).Enabled=   0   'False
         Tab(1).ControlCount=   29
         Begin VB.ComboBox Combo10 
            DataField       =   "COM221"
            DataSource      =   "adoND2Eexam2s"
            Height          =   315
            ItemData        =   "frmND2EExam.frx":23505
            Left            =   2400
            List            =   "frmND2EExam.frx":23524
            TabIndex        =   14
            Text            =   "..."
            Top             =   3240
            Width           =   1215
         ...
         Begin VB.ComboBox Combo11 
            ...
            DataSource      =   "adoND2Eexam2s"
            Height          =   315
            ItemData        =   "frmND2EExam.frx":23546
            Left            =   2400
            List            =   "frmND2EExam.frx":23565
            TabIndex        =   15
            Text            =   "..."
            Top             =   3600
            Width           =   1215
         ...
         Begin VB.ComboBox Combo12 
            ...
            DataSource      =   "adoND2Eexam2s"
            Height          =   315
            ItemData        =   "frmND2EExam.frx":23587
            Left            =   2400
            List            =   "frmND2EExam.frx":235A6
            TabIndex        =   16
            Text            =   "..."
            Top             =   3960
            Width           =   1215
         ...
         Begin VB.ComboBox Combo13 
            ...
            DataSource      =   "adoND2Eexam2s"
            Height          =   315
            ItemData        =   "frmND2EExam.frx":235C8
            Left            =   2400
            List            =   "frmND2EExam.frx":235E7
            TabIndex        =   17
            Text            =   "..."
            Top             =   4320
            Width           =   1215
         ...
         Begin VB.ComboBox Combo14 
            ...
            DataSource      =   "adoND2Eexam2s"
            Height          =   315
            ItemData        =   "frmND2EExam.frx":23609
            Left            =   2400
            List            =   "frmND2EExam.frx":23628
            TabIndex        =   18
            Text            =   "..."
            Top             =   4680
            Width           =   1215
         ...
         Begin VB.ComboBox Combo15 
            ...
            DataSource      =   "adoND2Eexam2s"
            Height          =   315
            ItemData        =   "frmND2EExam.frx":2364A
            Left            =   2400
            List            =   "frmND2EExam.frx":23669
            TabIndex        =   19
            Text            =   "..."
            Top             =   5040
            Width           =   1215
         ...
         Begin VB.ComboBox Combo16 
            ...
            DataSource      =   "adoND2Eexam2s"
            Height          =   315
            ItemData        =   "frmND2EExam.frx":2368B
            Left            =   2400
            List            =   "frmND2EExam.frx":236AA
            TabIndex        =   20
            Text            =   "..."
            Top             =   5400
            Width           =   1215
         ...
         Begin VB.ComboBox Combo17 
            ...
            DataSource      =   "adoND2Eexam2s"
            Height          =   315
            ItemData        =   "frmND2EExam.frx":236CC
            Left            =   2400
            List            =   "frmND2EExam.frx":236EB
            TabIndex        =   21
            Text            =   "..."
            Top             =   5760
            Width           =   1215
         ...
         Begin VB.ComboBox Combo2 
            ...
            DataSource      =   "adoND2Eexam1s"
            Height          =   315
            ItemData        =   "frmND2EExam.frx":2370D
            Left            =   -72600
            List            =   "frmND2EExam.frx":2372C
            TabIndex        =   3
            Text            =   "..."
            Top             =   3600
            Width           =   1215
         ...
         Begin VB.ComboBox Combo3 
            ...
            DataSource      =   "adoND2Eexam1s"
            Height          =   315
            ItemData        =   "frmND2EExam.frx":2374E
            Left            =   -72600
            List            =   "frmND2EExam.frx":2376D
            TabIndex        =   4
            Text            =   "..."
            Top             =   3960
            Width           =   1215
         ...
         Begin VB.ComboBox Combo4 
            ...
            DataSource      =   "adoND2Eexam1s"
            Height          =   315
            ItemData        =   "frmND2EExam.frx":2378F
            Left            =   -72600
            List            =   "frmND2EExam.frx":237AE
            TabIndex        =   5
            Text            =   "..."
            Top             =   4320
            Width           =   1215
         ...
         Begin VB.ComboBox Combo5 
            ...
            DataSource      =   "adoND2Eexam1s"
            Height          =   315
            ItemData        =   "frmND2EExam.frx":237D0
            Left            =   -72600
            List            =   "frmND2EExam.frx":237EF
            TabIndex        =   6
            Text            =   "..."
            Top             =   4680
            Width           =   1215
         ...
         Begin VB.ComboBox Combo6 
            ...
            DataSource      =   "adoND2Eexam1s"
            Height          =   315
            ItemData        =   "frmND2EExam.frx":23811
            Left            =   -72600
            List            =   "frmND2EExam.frx":23830
            TabIndex        =   7
            Text            =   "..."
            Top             =   5040
            Width           =   1215
         ...
         Begin VB.ComboBox Combo1 
            ...
            DataSource      =   "adoND2Eexam1s"
            Height          =   315
            ItemData        =   "frmND2EExam.frx":23852
            Left            =   -72600
            List            =   "frmND2EExam.frx":23871
            TabIndex        =   2
            Text            =   "..."
            Top             =   3240
            Width           =   1215
         ...
         Begin VB.ComboBox Combo7 
            ...
            DataSource      =   "adoND2Eexam1s"
            Height          =   315
            ItemData        =   "frmND2EExam.frx":23893
            Left            =   -72600
            List            =   "frmND2EExam.frx":238B2
            TabIndex        =   8
            Text            =   "..."
            Top             =   5400
            Width           =   1215
         ...
         Begin VB.Label Label66 
            ...
            Caption         =   "ND II(EVENING) EXAMINATION DETAILS (SECOND SEMESTER)"
            BeginProperty Font 
               Name            =   "Amelia"
               Size            =   20.25
               Charset         =   0
         ...
         Begin VB.Label Label47 
            Alignment       =   2  'Center
            BackStyle       =   0  'Transparent
            Caption         =   "ND II(EVENING) EXAMINATION DETAILS (FIRST SEMESTER)"
            BeginProperty Font 
               Name            =   "Amelia"
               Size            =   20.25
               Charset         =   0
      ...
      Begin VB.Image Image2 
         Height          =   1815
         Left            =   0
         Picture         =   "frmND2EExam.frx":238D4
         Stretch         =   -1  'True
         Top             =   0
         Width           =   7695
      End
   End
   Begin VB.Frame fraND2EExam 
      Height          =   9735
      Left            =   0
      TabIndex        =   25
      Top             =   0
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         BackColor       =   12648447
         TabCaption(0)   =   "First Semester"
         TabPicture(0)   =   "frmND2EExam.frx":476A2
         ...
         Tab(0).Control(25)=   "adoND2Eexam1s"
         ...
         TabCaption(1)   =   "Second Semester"
         TabPicture(1)   =   "frmND2EExam.frx":476BE
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "cmdAdd2"
         Tab(1).Control(1)=   "cmdDelete2"
         Tab(1).Control(2)=   "cmdSearch2"
         Tab(1).Control(3)=   "cmdBack2"
         Tab(1).Control(4)=   "adoND2Eexam2s"
         ...
         Tab(1).Control(12)=   "Label26"
         Tab(1).Control(13)=   "lblName2"
         ...
         Tab(1).Control(23)=   "Label28"
         Tab(1).Control(24)=   "Label29"
         Tab(1).Control(25)=   "Label30"
         Tab(1).Control(26)=   "Label31"
         Tab(1).Control(27)=   "Label32"
         Tab(1).Control(28)=   "Label36"
         Tab(1).Control(29)=   "Label37"
         Tab(1).Control(30)=   "Label43"
         Tab(1).Control(31)=   "Label45"
         ...
         Begin VB.CommandButton cmdBack2 
            ...
            Width           =   1215
         End
         Begin MSAdodcLib.Adodc adoND2Eexam1s 
            Height          =   615
            Left            =   840
            Top             =   6240
            Width           =   5895
            ...
            _Version        =   393216
         End
         Begin MSAdodcLib.Adodc adoND2Eexam2s 
            Height          =   615
            Left            =   -74160
            Top             =   6360
            Width           =   5895
...
adoND2Eexam1s.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:" & App.Path & "\ProjectStudents.mdb;Persist Security Info=False"
End Function
...
fraND2EEEdit.Visible = True
fraND2EExam.Visible = False
SSTab2.Tab = 0
End Sub
...
fraND2EExam.Visible = True
fraND2EEEdit.Visible = False
SSTab1.Tab = 0
End Sub
...
BookMark1 = adoND2Eexam1s.Recordset.Bookmark
adoND2Eexam1s.Recordset.MoveFirst
adoND2Eexam1s.Recordset.Find "regno = '" & con & "'", 0, adSearchForward
If adoND2Eexam1s.Recordset.EOF = True Then
adoND2Eexam1s.Recordset.Bookmark = BookMark1
...
On Error GoTo joe
GetConnect1
adoND2Eexam1s.Recordset.AddNew
Exit Sub
joe:
MsgBox Err.Description
End Sub
...
On Error GoTo joe
GetConnect2
adoND2Eexam2s.Recordset.AddNew
Exit Sub
joe:
MsgBox Err.Description
End Sub
...
Dim con As String
con = InputBox("Enter Student Reg. Number", "Search By Reg. No.")
BookMark1 = adoND2Eexam2s.Recordset.Bookmark
adoND2Eexam2s.Recordset.MoveFirst
adoND2Eexam2s.Recordset.Find "regno = '" & con & "'", 0, adSearchForward
If adoND2Eexam2s.Recordset.EOF = True Then
adoND2Eexam2s.Recordset.Bookmark = BookMark1
MsgBox ("No Record Found")
End If
Exit Sub
joe:
