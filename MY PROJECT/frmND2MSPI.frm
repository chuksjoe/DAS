...
Begin VB.Form frmND2MSPI 
   BackColor       =   &H00C0FFFF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "ND II(Morning) Student Personal Information"
   ClientHeight    =   11055
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   9945
   Icon            =   "frmND2MSPI.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   11055
   ...
   Begin VB.Frame fraND2MSPreview 
      BackColor       =   &H00C0FFC0&
      Height          =   10575
      Left            =   0
      TabIndex        =   38
      ...
      Begin VB.Image Image2 
         Height          =   720
         Left            =   0
         Picture         =   "frmND2MSPI.frx":234CD
         Stretch         =   -1  'True
         Top             =   0
         Width           =   9525
      End
   End
   Begin VB.Frame fraND2MSPI 
      BackColor       =   &H0000FF00&
      Height          =   10935
      Left            =   0
      TabIndex        =   0
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Width           =   1815
      End
      Begin MSAdodcLib.Adodc adoND2M 
         Height          =   375
         Left            =   2040
         Top             =   9840
         Width           =   4935
      ...
      Begin VB.Label Label21 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "ND II(MORNING) STUDENTS PERSONAL INFORMATION"
         BeginProperty Font 
            Name            =   "Amelia"
            Size            =   15.75
            Charset         =   0
      ...
      Begin VB.Image Image1 
         Height          =   1815
         Left            =   0
         Picture         =   "frmND2MSPI.frx":37B0D
         Stretch         =   -1  'True
         Top             =   0
         Width           =   8895
      End
   End
   Begin VB.Frame fraND2MSEditor 
      BackColor       =   &H0080FF80&
      Height          =   11175
      Left            =   0
      TabIndex        =   77
      ...
      Begin VB.Frame fraBiaData 
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.ComboBox cboDay 
               Height          =   315
               ItemData        =   "frmND2MSPI.frx":5B8DB
               Left            =   600
               List            =   "frmND2MSPI.frx":5B93C
               TabIndex        =   114
               Top             =   240
               Width           =   735
            End
            Begin VB.ComboBox cboMonth 
               Height          =   315
               ItemData        =   "frmND2MSPI.frx":5B9B3
               Left            =   2160
               List            =   "frmND2MSPI.frx":5B9DE
               TabIndex        =   113
               Top             =   240
               Width           =   975
            End
            Begin VB.ComboBox cboYear 
               Height          =   315
               ItemData        =   "frmND2MSPI.frx":5BA27
               Left            =   3840
               List            =   "frmND2MSPI.frx":5BAC4
               TabIndex        =   112
               Top             =   240
               Width           =   855
            End
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.ComboBox cboCountry 
               Height          =   315
               ItemData        =   "frmND2MSPI.frx":5BBFA
               Left            =   840
               List            =   "frmND2MSPI.frx":5BC04
               TabIndex        =   105
               Top             =   360
               Width           =   2295
            End
            Begin VB.ComboBox cboState 
               Height          =   315
               ItemData        =   "frmND2MSPI.frx":5BC19
               Left            =   5880
               List            =   "frmND2MSPI.frx":5BC8F
               TabIndex        =   104
               Top             =   360
               Width           =   2055
            End
            Begin VB.ComboBox cboReligion 
               Height          =   315
               ItemData        =   "frmND2MSPI.frx":5BDB3
               Left            =   5400
               List            =   "frmND2MSPI.frx":5BDC0
               TabIndex        =   103
               Top             =   720
               Width           =   2535
            End
      ...
      Begin VB.Label Label57 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "ND II(MORNING) STUDENT PERSONAL INFO EDITOR"
         BeginProperty Font 
            Name            =   "Amelia"
            Size            =   20.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmND2MSPI"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Function GetConnect1()
adoND2M.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:" & App.Path & "\ProjectStudents.mdb;Persist Security Info=False"
End Function

Private Sub cmdAdd_Click()
fraND2MSPI.Visible = False
fraND2MSPreview.Visible = True
Me.Width = 9570
Me.Height = 10950
End Sub
...
fraND2MSPI.Visible = True
fraND2MSPreview.Visible = False
Me.Width = 8955
Me.Height = 11325
End Sub
